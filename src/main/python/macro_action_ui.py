...
from keycodes import KEYCODES_BASIC, KEYCODES_ISO, KEYCODES_MEDIA, KEYCODES_MOUSE, KEYCODES_MODIFIERS, KEYCODES_NUMPAD, KEYCODES_SHIFTED, KEYCODES_LIGHTS, KEYCODES_DIAL
from macro_action import ActionText, ActionSequence, ActionDown, ActionUp, ActionTap, ActionDelay
from util import tr


MACRO_SEQUENCE_KEYCODES = KEYCODES_BASIC + KEYCODES_MODIFIERS + KEYCODES_NUMPAD + KEYCODES_SHIFTED +  KEYCODES_ISO + KEYCODES_MEDIA + KEYCODES_MOUSE + KEYCODES_LIGHTS + KEYCODES_DIAL
