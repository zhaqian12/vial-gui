...
class IndicatorsRGBHandler(BasicHandler):
    ...
    def __init__(self, container, row):
        ...
        container.addWidget(self.lbl_ind_rgb_title, row + 1, 3)

        self.lbl_caps_lock = QLabel(tr("RGBConfigurator", "Caps Lock 指示灯"))
        container.addWidget(self.lbl_caps_lock, row + 2, 3)

        self.lbl_caps_led = QLabel(tr("RGBConfigurator", "Caps LED"))
        container.addWidget(self.lbl_caps_led, row + 3, 3)
        ...
        container.addWidget(self.caps_effect, row + 5, 4)

        container.addWidget(self.lbl_blank, row + 6, 3)

        self.lbl_num_lock = QLabel(tr("RGBConfigurator", "Num Lock 指示灯"))
        container.addWidget(self.lbl_num_lock, row + 7, 3)

        self.lbl_num_led = QLabel(tr("RGBConfigurator", "Num LED"))
        container.addWidget(self.lbl_num_led, row + 8, 3)
        ...
        container.addWidget(self.num_effect, row + 10, 4)

        container.addWidget(self.lbl_blank, row + 11, 3)
        self.lbl_scroll_lock = QLabel(tr("RGBConfigurator", "Scroll Lock 指示灯"))
        container.addWidget(self.lbl_scroll_lock, row + 12, 3)
        
        self.lbl_scroll_led = QLabel(tr("RGBConfigurator", "Scroll LED"))
        container.addWidget(self.lbl_scroll_led, row + 13, 3)
        ...
        container.addWidget(self.scroll_effect, row + 15, 4)
